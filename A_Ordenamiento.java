	...
	{//inicio del metodo Shell
		...
		{//inicio del while
			...
			{//inicio del for
				...
				System.out.println(Temp.Cedula);
					...
					{//inicio del else
						...
						{//inicio del if
							Auxiliar=Temp2;Auxiliar.Cedula=Temp2.Cedula;
						    Auxiliar.Grado=A.Grado;
						    Auxiliar.Experiencia=A.Experiencia;
						    Auxiliar.Edad=A.Edad;
						    Auxiliar.Nombre=A.Nombre;JOptionPane.showMessageDialog(null,Auxiliar.toString(),"ESTE AUXILIAR", JOptionPane.ERROR_MESSAGE);													
		...
		{
			aux=aux.Siguiente;			
			for (int j2 = j-1; j2>=0 && T.Cedula>aux.Cedula ; j2--)
			{
				T.Siguiente=T;
				T=aux;
			}
